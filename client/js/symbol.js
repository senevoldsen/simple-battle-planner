...
(function (BP) {
    ...
    // Common / Set A
    const VERSION = new CodeMap();
    const CONTEXT = new CodeMap();
    const IDENTITY = new CodeMap();
    const SYMBOL_SET = new CodeMap();
    const STATUS = new CodeMap();
    const HQ_TF_DUMMY = new CodeMap();

    // Land Units
    const LAND_UNIT_ECHELON = new CodeMap();
    const LAND_UNIT_ENTITY = new CodeMap();
    const LAND_UNITS_MODIFIER_1 = new CodeMap();
    const LAND_UNITS_MODIFIER_2 = new CodeMap();

    // Land Equipment
    const LAND_EQUIPMENT_ECHELON = new CodeMap();
    ...
    */
    ...
    BP.symbol = {
        ...
        STATUS: STATUS,
        HQ_TF_DUMMY: HQ_TF_DUMMY,
        LAND_UNIT_ECHELON: LAND_UNIT_ECHELON,
        LAND_UNIT_ENTITY: LAND_UNIT_ENTITY,
        LAND_UNITS_MODIFIER_1: LAND_UNITS_MODIFIER_1,
        LAND_UNITS_MODIFIER_2: LAND_UNITS_MODIFIER_2,
        LAND_EQUIPMENT_ECHELON: LAND_EQUIPMENT_ECHELON
    };
})(window.BP = window.BP || {});
